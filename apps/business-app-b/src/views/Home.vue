 ...
 */
const goToAppA = () => {
  window.location.href = buildAppPath('/app-a/');
};
</script>
...
<template>
  <div class="home-container">
    ...
    <main class="main-content">
      ...
      <div class="card">
        <h3>应用导航</h3>
        <button @click="goToAppA" class="nav-btn">
          跳转到业务应用 A
        </button>
      </div>
      ...
      <div class="card">
        <h3>测试场景</h3>
        <p>尝试在另一个标签页打开应用 A，然后在此处点击"退出登录"，观察应用 A 是否自动同步登出状态。</p>
      </div>
    </main>
  </div>
</template>
